...
# Allowed users and cooldown tracking
allowed_user_ids = []
bgmi_cooldown = {}
free_user_credits = {"3"}
# Admin user IDs
...
Buy From :- @SPIDEYXX33
Official Channel :- https://t.me/Mr_Victor98
'''
...
def welcome_start(message):
    ...
    Try To Run This Command : /help To See Commands./n✅Join :- https://t.me/Mr_Victor98'''
    bot.reply_to(message, response)
...
def welcome_rules(message):
    ...
    response = (
        ...
        "1. Don't Run Too Many Attacks! It Can Cause A Ban From Bot.\n"
        "2. Don't Run 2 Attacks At The Same Time, Because If You Do, You Will Get Banned From Bot.\n"
